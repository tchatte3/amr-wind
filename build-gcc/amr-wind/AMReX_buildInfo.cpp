...
const char* buildInfoGetBuildDir() {
  ...
  static const char BUILD_DIR[] = "/gpfs/alpine/scratch/tchatte3/cfd142/codes_rebase/amr-wind/build-gcc";
  return BUILD_DIR;
}

const char* buildInfoGetBuildMachine() {

  static const char BUILD_MACHINE[] = "Linux login4 4.14.0-115.21.2.el7a.ppc64le #1 SMP Thu May 7 22:22:31 UTC 2020 ppc64le ppc64le ppc64le GNU/Linux";
  return BUILD_MACHINE;
}

const char* buildInfoGetAMReXDir() {

  static const char AMREX_DIR[] = "/gpfs/alpine/scratch/tchatte3/cfd142/codes_rebase/amr-wind/submods/amrex";
  return AMREX_DIR;
}
...
const char* buildInfoGetCXXFlags() {
  ...
  static const char CXX_flags[] = "-DAMR_WIND_USE_NETCDF -DAMR_WIND_USE_OPENFAST -I/autofs/nccs-svm1_proj/cfd142/exawind/exawind-2020-07/spack/opt/spack/linux-rhel7-power9le/gcc-7.4.0/netcdf-c-4.7.3-toy5urxedl22tu7qpd3f7hq54n233sbd/include -I/ccs/proj/cfd142/exawind/exawind-2020-07/install/gcc/openfast/include/ -I/gpfs/alpine/scratch/tchatte3/cfd142/codes_rebase/amr-wind -I/gpfs/alpine/scratch/tchatte3/cfd142/codes_rebase/amr-wind/build-gcc -O3 -DNDEBUG";
  return CXX_flags;
}

const char* buildInfoGetFFlags() {

  static const char F_flags[] = "-DAMR_WIND_USE_NETCDF -DAMR_WIND_USE_OPENFAST -I/autofs/nccs-svm1_proj/cfd142/exawind/exawind-2020-07/spack/opt/spack/linux-rhel7-power9le/gcc-7.4.0/netcdf-c-4.7.3-toy5urxedl22tu7qpd3f7hq54n233sbd/include -I/ccs/proj/cfd142/exawind/exawind-2020-07/install/gcc/openfast/include/ -I/gpfs/alpine/scratch/tchatte3/cfd142/codes_rebase/amr-wind -I/gpfs/alpine/scratch/tchatte3/cfd142/codes_rebase/amr-wind/build-gcc -O3 -DNDEBUG -O3";
  return F_flags;
}
...
const char* buildInfoGetGitHash(int i) {
  ...
  static const char HASH2[] = "20.05-42-g0c4606cf624a";
  static const char EMPT[] = "";
